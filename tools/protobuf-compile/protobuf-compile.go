...
func main() {
	if len(os.Args) != 2 {
		log.Fatal("Usage: go run github.com/muratcelep/terraform/tools/protobuf-compile <basedir>")
	}
	baseDir := os.Args[1]
