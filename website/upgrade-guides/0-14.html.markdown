...
[the Terraform Changelog](https://github.com/muratcelep/terraform/blob/v0.14/CHANGELOG.md).
...
[open a feature request issue](https://github.com/muratcelep/terraform/issues/new?labels=enhancement%2C+new&template=feature_request.md)
