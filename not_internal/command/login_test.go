...
import (
	...
	oauthserver "github.com/hashicorp/terraform/not_internal/command/testdata/login-oauth-server"
	tfeserver "github.com/hashicorp/terraform/not_internal/command/testdata/login-tfe-server"
