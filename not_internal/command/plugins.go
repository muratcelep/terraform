...
import (
	...
	fileprovisioner "github.com/hashicorp/terraform/not_internal/builtin/provisioners/file"
	localexec "github.com/hashicorp/terraform/not_internal/builtin/provisioners/local-exec"
	remoteexec "github.com/hashicorp/terraform/not_internal/builtin/provisioners/remote-exec"
	"github.com/hashicorp/terraform/not_internal/logging"
	tfplugin "github.com/hashicorp/terraform/not_internal/plugin"
	"github.com/hashicorp/terraform/not_internal/plugin/discovery"
...
func (m *Meta) provisionerFactories() map[string]provisioners.Factory {
	...
	// Wire up the not_internal provisioners first. These might be overridden
