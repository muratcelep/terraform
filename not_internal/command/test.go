...
import (
	...
	"github.com/hashicorp/terraform/not_internal/command/arguments"
	"github.com/hashicorp/terraform/not_internal/command/format"
	...
	"github.com/hashicorp/terraform/not_internal/moduletest"
	"github.com/hashicorp/terraform/not_internal/plans"
	"github.com/hashicorp/terraform/not_internal/providercache"
...
func (c *TestCommand) testSuiteProviders(suiteDirs testCommandSuiteDirs, testProvider *moduletest.Provider) (map[addrs.Provider]providers.Factory, tfdiags.Diagnostics) {
	...
	// We can safely use the not_internal providers returned by Meta here because
