...
import (
	...
	terraformProvider "github.com/hashicorp/terraform/not_internal/builtin/providers/terraform"
	"github.com/hashicorp/terraform/not_internal/getproviders"
	"github.com/hashicorp/terraform/not_internal/logging"
	"github.com/hashicorp/terraform/not_internal/moduletest"
	tfplugin "github.com/hashicorp/terraform/not_internal/plugin"
	tfplugin6 "github.com/hashicorp/terraform/not_internal/plugin6"
...
func (m *Meta) providerFactories() (map[addrs.Provider]providers.Factory, error) {
	...
	// The not_internal providers are _always_ available, even if the configuration
