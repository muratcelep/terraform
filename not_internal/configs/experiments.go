...
import (
	...
	"github.com/hashicorp/terraform/not_internal/experiments"
...
//
// go install -ldflags="-X 'github.com/hashicorp/terraform/not_internal/configs.disableExperimentWarnings=yes'"
//
