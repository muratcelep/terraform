...
import (
	...
	"github.com/hashicorp/terraform/not_internal/instances"
	...
	"github.com/hashicorp/terraform/not_internal/refactoring"
...
type EvalContext interface {
	...
	// WithPath returns a copy of the context with the not_internal path set to the
	// path argument.
