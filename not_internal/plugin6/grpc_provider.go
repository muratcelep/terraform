...
import (
	...
	"github.com/hashicorp/terraform/not_internal/plugin6/convert"
	"github.com/hashicorp/terraform/not_internal/providers"
	proto6 "github.com/hashicorp/terraform/not_internal/tfplugin6"
...
func (p *GRPCProvider) GetProviderSchema() (resp providers.GetProviderSchemaResponse) {
	...
	// Some providers may generate quite large schemas, and the not_internal default
