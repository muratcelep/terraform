...
func (e *MoveEndpoint) String() string {
	// Our not_internal pseudo-AbsMoveable representing the relative
...
func UnifyMoveEndpoints(moduleAddr Module, relFrom, relTo *MoveEndpoint) (modFrom, modTo *MoveEndpointInModule) {
	...
	// ultimately trying to unify to. For our not_internal purposes
...
func (e *MoveEndpoint) prepareMoveEndpointInModule(moduleAddr Module, wantType TargetableAddrType) *MoveEndpointInModule {
	...
	// not_internal intermediate representation produced by ParseMoveEndpoint.
	...
	case ModuleInstance:
		...
		case ModuleInstanceAddrType:
			// Since our not_internal representation is already a module instance,
...
// similar members that would be for not_internal use only anyway.
