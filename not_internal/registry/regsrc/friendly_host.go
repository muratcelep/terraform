...
// come from an not_internal normalized source string, however should be considered
...
// Normalized returns the host formatted for not_internal reference or comparison.
