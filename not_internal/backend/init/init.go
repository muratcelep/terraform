...
import (
	...
	"github.com/hashicorp/terraform/not_internal/tfdiags"
	"github.com/zclconf/go-cty/cty"

	backendLocal "github.com/hashicorp/terraform/not_internal/backend/local"
	backendRemote "github.com/hashicorp/terraform/not_internal/backend/remote"
	backendArtifactory "github.com/hashicorp/terraform/not_internal/backend/remote-state/artifactory"
	backendAzure "github.com/hashicorp/terraform/not_internal/backend/remote-state/azure"
	backendConsul "github.com/hashicorp/terraform/not_internal/backend/remote-state/consul"
	backendCos "github.com/hashicorp/terraform/not_internal/backend/remote-state/cos"
	backendEtcdv2 "github.com/hashicorp/terraform/not_internal/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/hashicorp/terraform/not_internal/backend/remote-state/etcdv3"
	backendGCS "github.com/hashicorp/terraform/not_internal/backend/remote-state/gcs"
	backendHTTP "github.com/hashicorp/terraform/not_internal/backend/remote-state/http"
	backendInmem "github.com/hashicorp/terraform/not_internal/backend/remote-state/inmem"
	backendKubernetes "github.com/hashicorp/terraform/not_internal/backend/remote-state/kubernetes"
	backendManta "github.com/hashicorp/terraform/not_internal/backend/remote-state/manta"
	backendOSS "github.com/hashicorp/terraform/not_internal/backend/remote-state/oss"
	backendPg "github.com/hashicorp/terraform/not_internal/backend/remote-state/pg"
	backendS3 "github.com/hashicorp/terraform/not_internal/backend/remote-state/s3"
	backendSwift "github.com/hashicorp/terraform/not_internal/backend/remote-state/swift"
	backendCloud "github.com/hashicorp/terraform/not_internal/cloud"
)
