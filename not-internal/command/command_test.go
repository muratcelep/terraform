...
import (
	...
	"github.com/muratcelep/terraform/not-internal/command/workdir"
	"github.com/muratcelep/terraform/not-internal/configs"
	"github.com/muratcelep/terraform/not-internal/configs/configload"
	"github.com/muratcelep/terraform/not-internal/configs/configschema"
	"github.com/muratcelep/terraform/not-internal/copy"
	"github.com/muratcelep/terraform/not-internal/depsfile"
	"github.com/muratcelep/terraform/not-internal/getproviders"
	"github.com/muratcelep/terraform/not-internal/initwd"
	legacy "github.com/muratcelep/terraform/not-internal/legacy/terraform"
	_ "github.com/muratcelep/terraform/not-internal/logging"
	"github.com/muratcelep/terraform/not-internal/plans"
	"github.com/muratcelep/terraform/not-internal/plans/planfile"
	"github.com/muratcelep/terraform/not-internal/providers"
	"github.com/muratcelep/terraform/not-internal/registry"
	"github.com/muratcelep/terraform/not-internal/states"
	"github.com/muratcelep/terraform/not-internal/states/statefile"
