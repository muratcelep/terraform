...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "-X github.com/muratcelep/terraform/internal/command/e2etest.terraformBin=./terraform$GOEXE" github.com/muratcelep/terraform/not-internal/command/e2etest
