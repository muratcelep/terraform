...
//
//     import oauthserver "github.com/muratcelep/terraform/not-internal/command/testdata/login-oauth-server"
...
import (
	...
	oauthserver "github.com/muratcelep/terraform/not-internal/command/testdata/login-oauth-server"
)
