...
func TestPlan_varsUnset(t *testing.T) {
	...
	// https://github.com/muratcelep/terraform/issues/26027
...
// https://github.com/muratcelep/terraform/issues/26035
...
// https://github.com/muratcelep/terraform/issues/28956
...
func TestPlan_shutdown(t *testing.T) {
	...
	p.PlanResourceChangeFn = func(req providers.PlanResourceChangeRequest) (resp providers.PlanResourceChangeResponse) {
		...
		// Because of the not-internal lock in the MockProvider, we can't
