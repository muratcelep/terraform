...
import (
	...
	terraformProvider "github.com/muratcelep/terraform/not-internal/builtin/providers/terraform"
	...
	tfplugin6 "github.com/muratcelep/terraform/not-internal/plugin6"
...
func (m *Meta) providerFactories() (map[addrs.Provider]providers.Factory, error) {
	...
	// The not-internal providers are _always_ available, even if the configuration
