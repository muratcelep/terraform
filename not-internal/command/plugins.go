...
import (
	...
	fileprovisioner "github.com/muratcelep/terraform/not-internal/builtin/provisioners/file"
	localexec "github.com/muratcelep/terraform/not-internal/builtin/provisioners/local-exec"
	remoteexec "github.com/muratcelep/terraform/not-internal/builtin/provisioners/remote-exec"
	"github.com/muratcelep/terraform/not-internal/logging"
	tfplugin "github.com/muratcelep/terraform/not-internal/plugin"
	"github.com/muratcelep/terraform/not-internal/plugin/discovery"
...
func (m *Meta) provisionerFactories() map[string]provisioners.Factory {
	...
	// Wire up the not-internal provisioners first. These might be overridden
