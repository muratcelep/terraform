...
func (e *MoveEndpoint) String() string {
	// Our not-internal pseudo-AbsMoveable representing the relative
...
func UnifyMoveEndpoints(moduleAddr Module, relFrom, relTo *MoveEndpoint) (modFrom, modTo *MoveEndpointInModule) {
	...
	// ultimately trying to unify to. For our not-internal purposes
...
func (e *MoveEndpoint) prepareMoveEndpointInModule(moduleAddr Module, wantType TargetableAddrType) *MoveEndpointInModule {
	...
	// not-internal intermediate representation produced by ParseMoveEndpoint.
	...
	case ModuleInstance:
		...
		case ModuleInstanceAddrType:
			// Since our not-internal representation is already a module instance,
...
// similar members that would be for not-internal use only anyway.
