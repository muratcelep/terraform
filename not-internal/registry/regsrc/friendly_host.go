...
// come from an not-internal normalized source string, however should be considered
...
// Normalized returns the host formatted for not-internal reference or comparison.
