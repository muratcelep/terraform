...
import (
	...
	backendLocal "github.com/muratcelep/terraform/not-internal/backend/local"
	backendRemote "github.com/muratcelep/terraform/not-internal/backend/remote"
	backendArtifactory "github.com/muratcelep/terraform/not-internal/backend/remote-state/artifactory"
	backendAzure "github.com/muratcelep/terraform/not-internal/backend/remote-state/azure"
	backendConsul "github.com/muratcelep/terraform/not-internal/backend/remote-state/consul"
	backendCos "github.com/muratcelep/terraform/not-internal/backend/remote-state/cos"
	backendEtcdv2 "github.com/muratcelep/terraform/not-internal/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/muratcelep/terraform/not-internal/backend/remote-state/etcdv3"
	backendGCS "github.com/muratcelep/terraform/not-internal/backend/remote-state/gcs"
	backendHTTP "github.com/muratcelep/terraform/not-internal/backend/remote-state/http"
	backendInmem "github.com/muratcelep/terraform/not-internal/backend/remote-state/inmem"
	backendKubernetes "github.com/muratcelep/terraform/not-internal/backend/remote-state/kubernetes"
	backendManta "github.com/muratcelep/terraform/not-internal/backend/remote-state/manta"
	backendOSS "github.com/muratcelep/terraform/not-internal/backend/remote-state/oss"
	backendPg "github.com/muratcelep/terraform/not-internal/backend/remote-state/pg"
	backendS3 "github.com/muratcelep/terraform/not-internal/backend/remote-state/s3"
	backendSwift "github.com/muratcelep/terraform/not-internal/backend/remote-state/swift"
	backendCloud "github.com/muratcelep/terraform/not-internal/cloud"
)
