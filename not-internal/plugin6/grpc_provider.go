...
import (
	...
	"github.com/muratcelep/terraform/not-internal/plugin6/convert"
	"github.com/muratcelep/terraform/not-internal/providers"
	proto6 "github.com/muratcelep/terraform/not-internal/tfplugin6"
...
func (p *GRPCProvider) GetProviderSchema() (resp providers.GetProviderSchemaResponse) {
	...
	// Some providers may generate quite large schemas, and the not-internal default
