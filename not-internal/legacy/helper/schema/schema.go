...
import (
	...
	"github.com/muratcelep/terraform/not-internal/legacy/terraform"
...
// SetProto5 enables a feature flag for any not-internal changes required required
...
func (m schemaMap) diffList(
	...
	default:
		return fmt.Errorf("%s: unknown element type (not-internal)", k)
	}
